...
export const services: Service[] = [
  {
    ...
    price: '1 200€',
    description: 'Le minimum vital pour exister sur le web. Un site simple, efficace et professionnel qui présente votre activité. Parfait pour les petits commerces qui veulent se lancer.',
    features: [
  ...
  },
  {
    ...
    price: '2 400€',
    description: 'Un site plus complet avec des fonctionnalités avancées. Idéal pour les commerces qui veulent vraiment marquer leur présence en ligne et faciliter la vie de leurs clients.',
    features: [
  ...
  },
  {
    ...
    price: '3 200€',
    description: 'Une boutique en ligne simple mais complète. Système de paiement sécurisé, gestion de vos produits, et tout ce qu\'il faut pour commencer à vendre sur le web sans complications.',
    features: [
